package com.learnhub.gateway.exception.handler;
...
import static com.learnhub.common.constants.ErrorInfo.Code.FAILED;
import static com.learnhub.common.constants.ErrorInfo.Msg.SERVER_INTER_ERROR;

/**
 * @author liming
 * @version 1.0
 * @since 2024/3/29 9:56
 */
@Slf4j
@Component
@AllArgsConstructor
public class GatewayExceptionHandler implements ErrorWebExceptionHandler, Ordered {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        if (requestIds != null) {
            result.requestId(requestIds.get(0));
        }
        byte[] resp = JsonUtils.toJsonStr(result).getBytes(StandardCharsets.UTF_8);
